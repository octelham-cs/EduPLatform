...
namespace EduPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260218174042_AddSupportTicketTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduPlatform.Core.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduPlatform.Core.Entities.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduPlatform.Core.Entities.TicketReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduPlatform.Core.Entities.SupportTicket", b =>
                {
                    b.HasOne("EduPlatform.Core.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("EduPlatform.Core.Entities.TicketReply", b =>
                {
                    b.HasOne("EduPlatform.Core.Entities.SupportTicket", "Ticket")
                        .WithMany("Replies")
